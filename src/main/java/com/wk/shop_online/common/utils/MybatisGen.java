package com.wk.shop_online.common.utils;
...
public class MybatisGen {
    ...
    public static void main(String[] args) {
        String path = System.getProperty("user.dir").concat(File.separator).concat("src").concat(File.separator).concat("main")
                .concat(File.separator).concat("java").concat(File.separator).concat("com").concat(File.separator).concat("wk").concat(File.separator).concat("shop_online").concat(File.separator);
        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/shop_online", "root", "kk020719")
                .globalConfig(builder -> {
                    builder.author("wk").enableSwagger(); // 设置作者// 开启 swagger 模式
